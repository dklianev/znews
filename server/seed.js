...
const DEFAULT_PERMISSIONS = [
  { role: 'admin', permissions: { articles: true, categories: true, ads: true, breaking: true, wanted: true, jobs: true, court: true, events: true, polls: true, comments: true, gallery: true, profiles: true, permissions: true } },
  { role: 'editor', permissions: { articles: true, categories: true, ads: true, breaking: true, wanted: false, jobs: false, court: false, events: true, polls: true, comments: true, gallery: true, profiles: false, permissions: false } },
  { role: 'reporter', permissions: { articles: true, categories: false, ads: false, breaking: false, wanted: false, jobs: false, court: false, events: false, polls: false, comments: false, gallery: true, profiles: false, permissions: false } },
  { role: 'photographer', permissions: { articles: false, categories: false, ads: false, breaking: false, wanted: false, jobs: false, court: false, events: false, polls: false, comments: false, gallery: true, profiles: false, permissions: false } },
  { role: 'intern', permissions: { articles: false, categories: false, ads: false, breaking: false, wanted: false, jobs: false, court: false, events: false, polls: false, comments: false, gallery: false, profiles: false, permissions: false } },
];
