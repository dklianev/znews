...
export const testSuites = [
  ...
  { name: 'articleRecencyPipeline', run: runArticleRecencyPipelineTests, vitestNative: true },
  ...
  { name: 'gamePuzzleHelpers', run: runGamePuzzleHelpersTests, vitestNative: true },
  ...
  { name: 'settingsPayloadHelpers', run: runSettingsPayloadHelpersTests, vitestNative: true },
