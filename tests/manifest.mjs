...
export const testSuites = [
  ...
  { name: 'numericId', run: runNumericIdTests },
  { name: 'articleRecencyPipeline', run: runArticleRecencyPipelineTests },
  { name: 'searchUtils', run: runSearchUtilsTests },
  ...
  { name: 'requestHelpers', run: runRequestHelpersTests },
  ...
  { name: 'touchSwipe', run: runTouchSwipeTests },
