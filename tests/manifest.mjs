...
export const testSuites = [
  ...
  { name: 'requestMetricsService', run: runRequestMetricsServiceTests },
  ...
  { name: 'imageOptimization', run: runImageOptimizationTests },
  { name: 'gamePuzzleHelpers', run: runGamePuzzleHelpersTests },
  { name: 'settingsHelpers', run: runSettingsHelpersTests },
  { name: 'articlePushHelpers', run: runArticlePushHelpersTests },
  { name: 'documentHelpers', run: runDocumentHelpersTests },
  { name: 'gamesCatalogService', run: runGamesCatalogServiceTests },
  { name: 'gameSharedHelpersService', run: runGameSharedHelpersServiceTests },
  { name: 'accessHelpers', run: runAccessHelpersTests },
  ...
  { name: 'webArticleMetaHelpers', run: runWebArticleMetaHelpersTests },
  { name: 'serverLifecycleService', run: runServerLifecycleServiceTests },
  { name: 'requestHelpers', run: runRequestHelpersTests, vitestNative: true },
  { name: 'runtimeBootstrapHelpers', run: runRuntimeBootstrapHelpersTests },
  { name: 'framePolicyService', run: runFramePolicyServiceTests },
  { name: 'remoteStorageService', run: runRemoteStorageServiceTests },
  { name: 'expressAsyncService', run: runExpressAsyncServiceTests },
