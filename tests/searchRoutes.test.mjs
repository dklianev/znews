...
describe('searchRoutes', () => {
  it('returns an empty typed payload for blank search queries', async () => {
  ...
  it('uses shared search helpers and filters results by requested type', async () => {
    const app = createMockApp();
  ...
  it('serves suggestion and trending endpoints with short-lived cache headers', async () => {
    const app = createMockApp();
  ...
  it('excludes archived articles from authenticated editor searches', async () => {
    const app = createMockApp();
