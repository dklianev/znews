...
import { useArticlesData } from '../context/DataContext';
        ...
        {trending.map((article, index) => (
          <div key={article.id}>
            <Link
              ...
              prefetch="intent"
              className={`comic-sidebar-row flex gap-3 group py-3 px-2 transition-all duration-200 mb-2 last:mb-0 hover:bg-zn-hot/8 hover:translate-x-0.5 ${index === 0 ? 'border-l-3 border-l-zn-hot pl-3' : index === 1 ? 'border-l-3 border-l-zn-orange pl-3' : ''
                }`}
            >
