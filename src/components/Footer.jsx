          ...
          <div className="mt-8 border-3 border-[#1C1428]/30 bg-[#1C1428]/5 dark:bg-[#1C1428]/40 px-5 py-4 relative" style={{ boxShadow: '3px 3px 0 rgba(28,20,40,0.15)' }}>
            <div className="flex gap-3 items-start">
              ...
              <p className="text-[11px] text-zn-text-muted dark:text-gray-400 font-sans leading-relaxed">
                <span className="font-bold text-zn-text dark:text-[#EDE4D0]">ZNEWS</span> е регистрирана медия, работеща под защитата на Закона за свободата на словото, пресата и правото на информация.
                Всички публикации представляват журналистическа дейност в обществен интерес.
                Редакцията защитава анонимността на своите източници съгласно чл.&nbsp;8 от Закона за защита на журналистическите източници.
                Опити за сплашване, заплахи или правни претенции към журналисти на ZNEWS ще бъдат публично оповестени и оспорвани с всички законови средства.
              </p>
            </div>
          </div>
